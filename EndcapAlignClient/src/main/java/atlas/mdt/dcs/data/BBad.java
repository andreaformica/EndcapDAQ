...
/**
 * BBad generated by hbm2java
 */
@Entity
@Table(name="B_BAD"
    ,schema="ATLAS_MDT_DCS"
)
public class BBad  implements java.io.Serializable {
    ...
    public BBad(BigDecimal imageId) {
        this.imageId = imageId;
    }
    public BBad(BigDecimal imageId, String imageName) {
       this.imageId = imageId;
