 ...
 */
@Entity
@Table(name = "AL_B_BNDS", schema = "ATLAS_MDT_DCS")
public class AlBBnds implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1076010620660398991L;
	...
	public AlBBnds(long imageId, BigDecimal stime, BigDecimal XNom,
			BigDecimal XBnd, BigDecimal YNom, BigDecimal YBnd,
			BigDecimal pxNom, BigDecimal pxBnd, BigDecimal exNom,
			BigDecimal exBnd, BigDecimal mxNom, BigDecimal mxBnd,
			BigDecimal mnNom, BigDecimal mnBnd) {
		this.imageId = imageId;
		this.stime = stime;
		this.XNom = XNom;
		this.XBnd = XBnd;
